...
import ExamPreparation.football.common.Command;
...
public class EngineImpl implements Engine {
    ...
    private String deliverySupplement(String[] data) {
        String fieldType = data[0];
        return controller.deliverySupplement(fieldType);
    }
    ...
    private String addPlayer(String[] data) {
        ...
        return controller.addPlayer(fieldName, playerType, playerName, playerNationality, playerStrength);
    }
